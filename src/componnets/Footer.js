...
const Footer = () => {
  return (
    <footer class="  w-full bg-neutral-950 bg-[radial-gradient(ellipse_-80%_-80%_at_-50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-10 pt-16">
                    ...
                    <div>
                        <a href="/">
                            <div class="flex items-center space-x-2 text-2xl font-medium">
                                <span>
                                    <img src="https://th.bing.com/th/id/OIG1.1YA_TZtQJkPygQfoMsL6?w=1024&h=1024&rs=1&pid=ImgDetMain" alt="AI Logo"
                                        width="64" height="64" class="w-16"/>
                                </span>
                                <span class="text-white">PortTrio</span>
                            </div>
            ...
            <div class="mt-16 border-t border-gray-400/30 pt-8 sm:mt-20 lg:mt-24">
                <div class="text-md text-center text-white">
                    ...
                    <span class="text-gray-50"> ♥  </span> by AI and
                    <a rel="noopener" href="/">Me.
                    </a>
                </div>
            </div>
        </div>
